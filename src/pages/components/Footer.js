                ...
                <Grid container spacing={3}>
                    <Grid item xs={12} sm={6} md={4}>
                        <Typography variant="body2" sx={{ display: 'flex', alignItems: 'center' }}>
                            <Link component={RouterLink} to="https://placement-cell-student.vercel.app/aboutus" color="inherit">
                    ...
                    <Grid item xs={12} sm={6} md={4}>
                        <Typography variant="body2" sx={{ display: 'flex', alignItems: 'center' }}>
                            <Link component={RouterLink} to="https://placement-cell-student.vercel.app/ContactUs" color="inherit">
                                <Typography variant="h6" gutterBottom sx={linkStyle}>
                                    Contact Us
                                </Typography>
                            </Link>
